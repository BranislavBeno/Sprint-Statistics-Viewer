...
public class SprintRefinementRowMapper implements RowMapper<SprintRefinement> {
     ...
     * The log.
     */
    private static final Log LOG = LogFactory.getLog(SprintRefinementRowMapper.class);
    ...
    private Map<FeatureScope, Integer> gatherRefinedStoryPoints(String refinementJson) {
        ...
        try {
            refinedStoryPoints = new ObjectMapper().readValue(refinementJson, new TypeReference<>() {
            });
