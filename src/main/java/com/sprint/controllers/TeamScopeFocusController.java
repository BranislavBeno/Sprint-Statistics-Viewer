...
public class TeamScopeFocusController {
     ...
     * The team.
     */
    private final TeamScopeFocusDAO team;
    ...
    private Map<FeatureScope, List<Integer>> collectPercentageLists(final Map<FeatureScope, List<Integer>> spLists) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            int basicPercentage = (int) (100 - futurePercentage - commercialPercentage
                    - advancedPercentage);

            // Fill particular percentage lists
            futureList.add((int) futurePercentage);
            commercialList.add((int) commercialPercentage);
            advancedList.add((int) advancedPercentage);
